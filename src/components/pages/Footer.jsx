...
function Footer() {
    return (
      <footer className='w-full h-[30vh] bg-transparent text-black md:bg-black md:text-white  py-6  bottom-0 '>
        <div className='container mx-auto flex flex-col md:flex-row justify-around items-center md:text-center'>
          <div className='w-full md:w-1/4 text-left md:text-center mb-4 md:mb-0'>
            <p className='text-sm'>
          ...
          <div className='w-full md:w-1/4 mb-4 md:mb-0 ml-6'>
