...
function Galary() {
  return (
    ...
    <div className="container mx-auto p-4 bg-gray-50 mt-16">
        <h1 className="text-3xl text-center font-bold mb-4">Gallery Our Company Collagon</h1>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            
            <div className="relative group">
                <img className="rounded-lg shadow-md h-[90%]" src='' alt="Picture 1" />
            ...
            <div className="relative group">
                <img className="rounded-lg shadow-md h-[90%]" src='' alt="Picture 2" />
                <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-50 transition-opacity flex items-center justify-center">
            ...
            <div className="relative group">
                <img className="rounded-lg shadow-md h-[90%]" src='' alt="Picture 3" />
                <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-50 transition-opacity flex items-center justify-center">
            ...
            <div className="relative group">
                <img className="rounded-lg shadow-md h-[90%]" src='' alt="Picture 4" />
                <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-50 transition-opacity flex items-center justify-center">
