...
function About() {
    return (
        <div className='w-[90%] h-[70vh] m-auto flex flex-row justify-evenly items-center'>
            <div className='w-[40%]'>
                <img className='w-[100%] h-80' src="https://template63469.motopreview.com/mt-demo/63400/63469/mt-content/uploads/2017/06/mt-1028-about-img.jpg" alt="a guard" />
            </div>
            <div className='w-[50%]'>
                <h1 className='text-center font-extrabold text-4xl font-serif mb-6 hover:text-cyan-900'>About Our Company</h1>
                <p className='text-left font-semibold text-gray-600 line-clamp-10 text-sm text-wrap'>
